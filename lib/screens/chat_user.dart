...
class _ChatPrivateScreenState extends State<ChatPrivateScreen> {
    ...
    if (response.statusCode == 200) {
      ...
      if (responseJson['chat_history'] != null) {
        for (final chatHistoryJson in responseJson['chat_history']) {
          ...
          types.Message message = convertToMessageType(chatHistory);
  ...
  types.Message convertToMessageType(ChatHistory chatHistory) {
    ...
    json["author"] = {
      ...
      "imageUrl": chatHistory.senderId != currentUser.id
          ? _userReceiveInfo.url
          : currentUser.imageUrl,
      "firstname": chatHistory.senderId != currentUser.id
